            ...
            <div className="grid gap-2xl">
              ...
              <section>
                ...
                <p className="text-muted mb-md">
                  By purchasing, downloading, installing, or using Carvd Studio ("the Software"),
                  you agree to be bound by these Terms of Service ("Terms"). If you do not agree
                  to these Terms, do not use the Software.
                </p>
                <p className="text-muted">
                  These Terms constitute a legal agreement between you and Carvd Studio ("we," "us," or "our").
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="grid gap-sm text-muted">
                  <li>- Install and use the Software on up to three (3) devices that you own or control</li>
                  <li>- Use the Software for personal or commercial purposes</li>
                  <li>- Receive all future updates to the Software at no additional cost</li>
                </ul>
                <p className="text-muted mt-md">
                  This license is perpetual, meaning you own the right to use the Software indefinitely,
                  even if you later request deletion of your account or purchase records.
                </p>
              </section>

              {/* Restrictions */}
              <section>
                <h2 className="text-2xl font-bold mb-md">License Restrictions</h2>
                <p className="text-muted mb-md">
                  You may not:
                </p>
                <ul className="grid gap-sm text-muted">
                  <li>- Share, distribute, or sell your license key to others</li>
                  ...
                  <li>- Circumvent or disable any license verification mechanisms</li>
                </ul>
              </section>

              {/* Ownership */}
              <section>
                <h2 className="text-2xl font-bold mb-md">Intellectual Property</h2>
                <p className="text-muted mb-md">
                  The Software is protected by copyright and other intellectual property laws.
                  We retain all rights, title, and interest in and to the Software, including
                  all intellectual property rights.
                </p>
                <p className="text-muted">
                  Your purchase grants you a license to use the Software, not ownership of the
                  Software itself.
                </p>
              </section>
              ...
              {/* Your Content */}
              <section>
                <h2 className="text-2xl font-bold mb-md">Your Designs and Content</h2>
                <p className="text-muted">
                  You retain full ownership of all designs, project files, and other content
                  you create using the Software. We claim no rights to your work. Your files
                  are stored locally on your computer and are never transmitted to us.
                </p>
              </section>

              {/* Money-Back Guarantee */}
              <section>
                <h2 className="text-2xl font-bold mb-md">30-Day Money-Back Guarantee</h2>
                <p className="text-muted mb-md">
                  We offer a 30-day, no-questions-asked money-back guarantee. If you're not
                  satisfied with Carvd Studio for any reason, contact us within 30 days of
                  your purchase for a full refund.
                </p>
                <p className="text-muted">
                  To request a refund, email us at{' '}
                  <a href="mailto:support@carvd-studio.com" className="text-accent">support@carvd-studio.com</a>{' '}
              ...
              <section>
                ...
                <p className="text-muted">
                  We may release updates to the Software from time to time. These updates may
                  include bug fixes, new features, or security improvements. All updates are
                  provided free of charge to licensed users. You are not required to install
                  updates, but we recommend keeping your Software up to date for the best experience.
                </p>
              </section>

              {/* Disclaimer */}
              <section>
                <h2 className="text-2xl font-bold mb-md">Disclaimer of Warranties</h2>
                <p className="text-muted mb-md">
                ...
                <p className="text-muted">
                  ...
                  interruption, or be error-free. You assume all responsibility for selecting the
              ...
              <section>
                <h2 className="text-2xl font-bold mb-md">Limitation of Liability</h2>
                <p className="text-muted mb-md">
              ...
              <section>
                ...
                <p className="text-muted">
                  Sections regarding intellectual property, disclaimer of warranties, limitation
              ...
              <section>
                ...
                <p className="text-muted">
                  ...
                  arising under these Terms shall be resolved in the courts of competent jurisdiction.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted">
                  ...
                  "Last updated" date. Your continued use of the Software after such changes
