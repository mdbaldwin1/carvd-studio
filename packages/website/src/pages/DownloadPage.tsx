          ...
          <div className="max-w-3xl mx-auto">
            <div className="version-entry">
              <div className="version-header">
                ...
                <span className="version-date">Current Release</span>
              ...
              <div className="version-content">
                ...
                <ul className="version-changes">
                  ...
                  <li>Cost tracking with custom pricing per material</li>
                  <li>Project templates and reusable assemblies</li>
                  <li>PDF export for cut lists and project summaries</li>
                  <li>Stock library management with custom materials</li>
                  <li>Offline-first architecture - no internet required</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="container mt-3xl">
          ...
          <div className="grid grid-cols-2 gap-xl max-w-4xl mx-auto">
            ...
            <div className="card">
              ...
              <ul className="requirements-list">
                <li>
                  <strong>OS:</strong> Windows 10 or later (64-bit)
                </li>
                <li>
        ...
        <section className="container mt-3xl mb-3xl">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="faq-item">
              <h3 className="faq-question">Is the download safe?</h3>
              <p className="faq-answer">
                Yes! Carvd Studio is built with Electron, the same framework
                used by VS Code, Slack, and Discord. Our installers are
                code-signed and verified. The security warnings you may see are
                standard for new apps that haven't yet built up reputation with
                OS vendors.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p className="faq-answer">
                ...
                exports, and all templates. After the trial, you can purchase a
            ...
            <div className="faq-item">
              ...
              <p className="faq-answer">
                ...
                also manually check by going to Help → Check for Updates in the
                app menu. Updates are downloaded in the background and installed
            ...
            <div className="faq-item">
              ...
              <p className="faq-answer">
                Yes! Your license can be activated on up to 3 computers at once.
                If you need to move to a new machine, you can deactivate your
                license in the app settings before activating on the new
                computer.
              </p>
            </div>
          </div>
        ...
        <section className="container mb-3xl">
          <div className="cta-section">
            ...
            <div className="flex justify-center gap-md">
              <a href={macDownload.url} className="btn btn-highlight btn-lg">
                Download for macOS
              </a>
              <a href={windowsDownload.url} className="btn btn-outline btn-lg">
