          ...
          <div className="max-w-4xl mx-auto text-center">
              ...
              >
                <div className="text-center mb-xl">
                  ...
                  <div className="text-sm text-muted mb-lg">
                    <span className="line-through">$99</span> — Early adopter
                    pricing
                  </div>
                  <p className="text-sm text-success mb-md">
                    <Lightbulb size={16} /> The cut list optimizer alone
                    typically saves more than $59 in wasted lumber on a single
                    project
                  </p>
                ...
                <div className="mb-xl">
                  ...
                  <ul className="checklist">
                    ...
                    <li>
                      <span>
                        Joinery allowances for extra material on tenons, dados,
                        etc.
                      </span>
                    </li>
                    <li>
                ...
                <div className="text-center">
                  <p className="text-sm text-muted mb-sm">
                    ✓ 30-day money-back guarantee &nbsp;•&nbsp; ✓ Instant
                    download &nbsp;•&nbsp; ✓ Secure checkout
                  </p>
                  <p className="text-xs text-muted">
                    You'll receive your license key via email within minutes of
                    purchase
                  </p>
                </div>
              </div>
            ...
            <div className="mb-3xl mt-3xl">
              ...
              <p className="text-xl text-muted text-center mb-xl max-w-2xl mx-auto">
                If you think you'll use furniture design software for more than
                half a year, Carvd Studio is the smart choice.
              </p>
              <div className="grid grid-cols-2 gap-2xl">
                <div className="card">
                  ...
                  <div className="text-center mb-md">
                    <div className="text-4xl font-bold text-muted mb-sm">
                      $10/mo
                    </div>
            ...
            <div className="accent-box mb-3xl mt-3xl">
              ...
              <div className="grid grid-cols-3 gap-lg">
                <div className="text-center">
                  ...
                  <div className="text-3xl font-bold text-highlight mb-sm">
                    $80
                  </div>
            ...
            <div className="mb-3xl mt-3xl">
              ...
              <p className="text-xl text-muted text-center mb-xl max-w-2xl mx-auto">
                We researched the competition so you don't have to. Here's how
                Carvd Studio stacks up.
              </p>
              ...
              <div className="grid grid-cols-2 gap-lg mt-xl">
                <div className="accent-box">
                  ...
                  <p className="text-muted text-sm">
                    SketchUp and Fusion 360 are powerful, but they're designed
                    for architects and engineers—not woodworkers. You'll spend
                    hours learning features you don't need, and you still won't
                    get optimized cut lists.
                  </p>
                </div>
                <div className="accent-box">
                  <h3 className="text-xl font-bold mb-sm">
                  ...
                  <p className="text-muted text-sm">
                    Cabinet Vision and SketchList 3D are woodworking-focused,
                    but their subscription costs add up fast. In one year, you'd
                    pay more than 10x the cost of Carvd Studio.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid gap-xl">
                <div className="card">
                  ...
                  <p className="card-description">
                    Yes. $59.99 once, and you own Carvd Studio forever. No
                    monthly fees, no annual renewals, no surprise charges. We
                    hate subscriptions as much as you do.
                  </p>
                </div>
                ...
                <div className="card">
                  ...
                  <p className="card-description">
                    ...
                    If Carvd Studio doesn't save you time and money, email us
                    for a full refund. You risk nothing.
                  </p>
                </div>
                ...
                <div className="card">
                  ...
                  <p className="card-description">
                    Your license works on up to 3 devices—any combination of Mac
                    and Windows. Use it in your shop, office, and on your
                    laptop. All three at the same time if you want.
                  </p>
                </div>
                ...
                <div className="card">
                  ...
                  <p className="card-description">
                    Yes. Carvd Studio works 100% offline. Take your laptop to
                    job sites, work in your shop without WiFi, design anywhere.
                ...
                <div className="card">
                  ...
                  <p className="card-description">
                    Email us anytime at support@carvd-studio.com. You'll get
                    help from actual woodworkers who know the software inside
                    and out. Most questions answered within 24 hours.
                  </p>
                </div>
                ...
                <div className="card">
                  ...
                  <p className="card-description">
                    Great question. Contact us at support@carvd-studio.com for
                    team pricing on 5+ licenses. We offer volume discounts for
                    shops and schools.
                  </p>
                </div>
              </div>
