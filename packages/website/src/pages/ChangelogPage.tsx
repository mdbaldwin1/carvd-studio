        ...
        <div className="py-3xl">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-muted mb-3xl">
              All notable changes to Carvd Studio are documented here.
              ...
              {versions.map((version) => (
                ...
                >
                  <div className="flex items-center gap-md mb-lg">
                    <span className="badge badge-highlight">v{version.version}</span>
                    <span className="text-muted text-sm">{formatDate(version.date)}</span>
                  </div>

                  {version.categories.map((category) => (
                    <div key={category.name} className="mb-xl">
                      <div className="mb-md">
                        <span className={`badge ${getCategoryBadgeClass(category.name)}`}>
                          {category.name}
                        </span>
                      </div>
