        ...
        <div className="py-3xl">
          <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-xl">
                ...
                <div className="troubleshoot-item">
                  <h4 className="troubleshoot-question">
                    macOS: "Carvd Studio can't be opened because Apple cannot
                    check it for malicious software"
                  </h4>
                  <div className="troubleshoot-answer">
                    <p>
                      This is a standard macOS security feature for apps
                      downloaded from the internet. To open the app:
                    </p>
                    ...
                    <p className="text-muted mt-sm">
                      You only need to do this once. Future launches will work
                      normally.
                    </p>
                  </div>
                </div>
                ...
                <div className="troubleshoot-item">
                  <h4 className="troubleshoot-question">
                    Windows: SmartScreen prevented an unrecognized app from
                    starting
                  </h4>
                  <div className="troubleshoot-answer">
                    <p>
                      Windows SmartScreen shows this warning for new apps. To
                      proceed:
                    </p>
                    <ol className="troubleshoot-steps">
                    ...
                    <p className="text-muted mt-sm">
                      This warning will disappear as more users install the app
                      and Microsoft builds trust with our certificate.
                    </p>
                  </div>
                </div>
                ...
                <div className="troubleshoot-item">
                  ...
                  <div className="troubleshoot-answer">
                    ...
                    <ol className="troubleshoot-steps">
                      ...
                      <li>
                        Check if your antivirus is blocking the app and add an
                        exception if needed
                      </li>
                    </ol>
                  </div>
              ...
              <div className="mb-xl">
                ...
                <div className="troubleshoot-item">
                  ...
                  <div className="troubleshoot-answer">
                    ...
                    <ol className="troubleshoot-steps">
                      <li>
                        Check for typos - copy and paste the key directly from
                        your email
                      </li>
                      <li>Make sure you're connected to the internet</li>
                      <li>
                        Check that you haven't exceeded the activation limit (3
                        devices)
                      </li>
                      <li>
                        If you've reached the limit, deactivate an old device
                        first in Settings → License
                      </li>
                    </ol>
                  </div>
                </div>
                ...
                <div className="troubleshoot-item">
                  ...
                  <div className="troubleshoot-answer">
                    <p>
                      You can activate your license on up to 3 computers. To
                      move it:
                    </p>
                    <ol className="troubleshoot-steps">
                ...
                <div className="troubleshoot-item">
                  ...
                  <div className="troubleshoot-answer">
                    <p>
                      ...
                      and we'll extend your trial so you have enough time to
              ...
              <div className="mb-xl">
                ...
                <div className="troubleshoot-item">
                  ...
                  <div className="troubleshoot-answer">
                    ...
                    <ol className="troubleshoot-steps">
                      ...
                      <li>
                        Try opening the auto-recovery version: File → Recover
                        Auto-Saved Project
                      </li>
                      <li>
                        Make sure the file isn't on a network drive or cloud
                        storage that's offline
                      </li>
                    </ol>
                    <p className="text-muted mt-sm">
                ...
                <div className="troubleshoot-item">
                  ...
                  <div className="troubleshoot-answer">
                    ...
                    <ol className="troubleshoot-steps">
                      ...
                      <li>
                        On laptops, ensuring you're plugged in (battery mode
                        reduces performance)
                      </li>
                    </ol>
                  </div>
                ...
                <div className="troubleshoot-item">
                  ...
                  <div className="troubleshoot-answer">
                    ...
                    <ol className="troubleshoot-steps">
                      <li>
                        Verify your stock dimensions are correct in the Stock
                        Library
                      </li>
                      <li>
                        Check the kerf (blade width) setting in your project
                        settings
                      </li>
                      <li>
                        Make sure grain direction is set correctly on
                        grain-sensitive parts
                      </li>
                      <li>
            ...
            <section id="faq" className="mt-3xl mb-3xl">
              <h2 className="text-3xl font-bold mb-xl">
              ...
              <div className="faq-category">
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    Carvd Studio is a desktop application for designing
                    furniture and generating optimized cut lists. It helps
                    woodworkers and furniture makers plan their projects in 3D,
                    minimize material waste, and track costs - all without
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    No! Carvd Studio is designed to work completely offline.
                    Your projects are saved locally on your computer. Internet
                    is only needed for license activation and checking for
                    updates.
                  </p>
                </div>
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    ...
                    Project files use our .carvd format which preserves all your
                    3D design data, materials, and settings.
                  </p>
                </div>
              </div>
              ...
              <div className="faq-category">
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    Yes! You get a 14-day free trial with full access to all
                    features. No credit card required. After the trial, you can
                    purchase a license or continue with the free version which
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    No, Carvd Studio is a one-time purchase. Pay once, own it
                    forever. You'll also receive free updates for the lifetime
                    of version 1.x.
                  </p>
                </div>
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    Your license can be activated on up to 3 computers at once.
                    This is per license, not per household, so a single license
                    works great for your workshop computer, laptop, and home
                    office.
                  </p>
                </div>
              ...
              <div className="faq-category">
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    ...
                    exploring import options for future versions. For now, you
                    can recreate designs using our intuitive 3D tools.
                  </p>
                </div>
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    Yes! You can work in inches, feet, millimeters, or
                    centimeters. Switch between unit systems at any time in your
                    project settings.
                  </p>
                </div>
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    Yes, with a paid license you can save any project as a
                    template for future use. You can also create reusable
                    assemblies (like drawer boxes or cabinet carcasses) to speed
                    up your workflow.
                  </p>
                </div>
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    Our optimizer uses advanced algorithms to arrange your parts
                    on stock material with minimal waste. It considers grain
                    direction, part dimensions, kerf width, and your stock
                    inventory to find the most efficient cutting layout.
                  </p>
                </div>
              </div>
              ...
              <div className="faq-category">
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    <strong>macOS:</strong> 10.15 (Catalina) or later, Intel or
                    Apple Silicon
                    <br />
                    <strong>Windows:</strong> Windows 10 or later (64-bit)
                    <br />
                    <strong>RAM:</strong> 4 GB minimum (8 GB recommended for
                    large projects)
                    <br />
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    Projects are saved wherever you choose when you save them.
                    By default, Carvd Studio suggests your Documents folder.
                    Auto-recovery files are stored in your system's application
                    data folder.
                  </p>
                </div>
                ...
                <div className="faq-item">
                  ...
                  <p className="faq-answer">
                    ...
                    can also manually check by going to Help → Check for
                    Updates. Updates are downloaded in the background and
              ...
              <div className="grid grid-cols-2 gap-xl">
                <div className="card">
                  ...
                  <p className="text-muted mb-lg">
                    For technical issues, license questions, or general
                ...
                <div className="card">
                  ...
                  <p className="text-muted mb-lg">
                    Learn how to use Carvd Studio with our comprehensive
