...
describe('DownloadPage', () => {
  ...
  describe('rendering', () => {
    it('renders without crashing', () => {
      renderDownloadPage();
      expect(screen.getByRole('heading', { level: 1, name: /Download Carvd Studio/i })).toBeInTheDocument();
    });
  ...
  describe('download cards', () => {
    ...
    it('has correct macOS download link', () => {
      ...
      expect(macLinks[0]).toHaveAttribute('href', expect.stringContaining('.dmg'));
    });
    ...
    it('has correct Windows download link', () => {
      ...
      expect(windowsLinks[0]).toHaveAttribute('href', expect.stringContaining('.exe'));
    });
  });
  ...
  describe('system requirements', () => {
    ...
    it('renders macOS requirements', () => {
      renderDownloadPage();
      expect(screen.getByText(/macOS 10.15 \(Catalina\) or later/i)).toBeInTheDocument();
    });

    it('renders Windows requirements', () => {
      renderDownloadPage();
      expect(screen.getByText(/Windows 10 or later \(64-bit\)/i)).toBeInTheDocument();
    });
  });
  ...
  describe('FAQ', () => {
    ...
    it('renders offline question', () => {
      renderDownloadPage();
      expect(screen.getByText(/Do I need an internet connection\?/i)).toBeInTheDocument();
    });
    ...
    it('renders license transfer question', () => {
      renderDownloadPage();
      expect(screen.getByText(/Can I transfer my license to a new computer\?/i)).toBeInTheDocument();
    });
  });
  ...
  describe('CTA section', () => {
    it('renders CTA section', () => {
      renderDownloadPage();
      expect(screen.getByText(/Ready to start designing\?/i)).toBeInTheDocument();
    });
