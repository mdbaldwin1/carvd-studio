...
describe("SupportPage", () => {
  ...
  describe("Troubleshooting Section", () => {
    it("renders troubleshooting heading", () => {
      ...
      const troubleshootingHeading = headings.find(
        (h) => h.textContent === "Troubleshooting",
      );
    ...
    it("renders macOS installation troubleshoot", () => {
      ...
      expect(
        screen.getByText(
          /carvd studio can't be opened because apple cannot check/i,
        ),
      ).toBeInTheDocument();
    });
    ...
    it("renders Windows SmartScreen troubleshoot", () => {
      renderSupportPage();
      expect(
        screen.getByText(/smartscreen prevented an unrecognized app/i),
      ).toBeInTheDocument();
    });
    ...
    it("renders license key troubleshoot", () => {
      renderSupportPage();
      expect(
        screen.getByText(/my license key isn't working/i),
      ).toBeInTheDocument();
    });
    ...
    it("renders project file troubleshoot", () => {
      renderSupportPage();
      expect(
        screen.getByText(/my project file won't open/i),
      ).toBeInTheDocument();
    });
    ...
    it("renders 3D view performance troubleshoot", () => {
      renderSupportPage();
      expect(
        screen.getByText(/the 3d view is slow or laggy/i),
      ).toBeInTheDocument();
    });
    ...
    it("renders cut list troubleshoot", () => {
      renderSupportPage();
      expect(
        screen.getByText(/cut list calculations seem wrong/i),
      ).toBeInTheDocument();
    });
  });
  ...
  describe("FAQ Section", () => {
    ...
    it("renders General FAQ category", () => {
      renderSupportPage();
      expect(
        screen.getByRole("heading", { level: 3, name: /^general$/i }),
      ).toBeInTheDocument();
    });
    ...
    it("renders Pricing & Licensing FAQ category", () => {
      renderSupportPage();
      expect(
        screen.getByRole("heading", { level: 3, name: /pricing & licensing/i }),
      ).toBeInTheDocument();
    });
    ...
    it("renders Technical FAQ category", () => {
      renderSupportPage();
      expect(
        screen.getByRole("heading", { level: 3, name: /^technical$/i }),
      ).toBeInTheDocument();
    });
    ...
    it("renders FAQ about offline usage", () => {
      renderSupportPage();
      expect(
        screen.getByText(/do i need internet to use carvd studio\?/i),
      ).toBeInTheDocument();
    });
    ...
    it("renders FAQ about license computers", () => {
      renderSupportPage();
      expect(
        screen.getByText(/how many computers can i use my license on\?/i),
      ).toBeInTheDocument();
    });
  ...
  describe("Contact Section", () => {
    ...
    it("renders support email link", () => {
      ...
      const emailLinks = screen.getAllByRole("link", {
        name: /support@carvd-studio\.com/i,
      });
    ...
    it("renders support checklist", () => {
      renderSupportPage();
      expect(
        screen.getByText(/when contacting support, please include/i),
      ).toBeInTheDocument();
      expect(
        screen.getByText(/your operating system.*and version/i),
      ).toBeInTheDocument();
  ...
  describe("CTA Section", () => {
    ...
    it("renders CTA description", () => {
      renderSupportPage();
      expect(
        screen.getByText(/our support team is here to help/i),
      ).toBeInTheDocument();
    });
