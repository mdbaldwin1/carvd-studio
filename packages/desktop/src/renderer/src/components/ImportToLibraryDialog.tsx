...
export function ImportToLibraryDialog({
  ...
  const [selectedStockIds, setSelectedStockIds] = useState<Set<string>>(
    () => new Set(missingStocks.map(s => s.id))
  );
      ...
      <div className="modal import-to-library-dialog">
        ...
        <div className="modal-body">
          <p className="import-message">
            This project contains {totalItems} item{totalItems !== 1 ? 's' : ''} not in your library.
            Would you like to add them for use in future projects?
          </p>
