...
const DialogOverlay = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  function DialogOverlay({ className, ...props }, ref) {
    return (
      <div
        ref={ref}
        className={cn('fixed inset-0 bg-overlay z-[1100]', className)}
        {...props}
      />
    );
  }
...
const DialogContent = forwardRef<HTMLDivElement, DialogContentProps>(
  function DialogContent({ className, onClose, role = 'dialog', children, ...props }, ref) {
    const titleId = useId();
...
const DialogFooter = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  function DialogFooter({ className, ...props }, ref) {
    return (
      <div
        ref={ref}
        className={cn('flex justify-end gap-2 py-4 px-5 border-t border-border', className)}
        {...props}
      />
    );
  }
...
const DialogClose = forwardRef<HTMLButtonElement, DialogCloseProps>(
  function DialogClose({ className, onClose, ...props }, ref) {
    return (
      <button
        ref={ref}
        className={cn(
