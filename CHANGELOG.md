...
- **Mitre and paired-dowel assemblies** — Complementary mitres now snap at their actual cut faces without ghost overlap, including flipped, shallow-angle, bevel, and compound ends. Paired dowels now validate the real hole diameters and alignment, retain their relationship through edits, become ordinary holes when a mate is removed, and restore paired deletion atomically with undo.
