...
| `download_clicked` | Installer link click before normal navigation      | `platform=macos-arm64\|macos-x64\|windows`; `location=home-hero-card\|download-hero-card\|download-cta-footer` | Installer intent and acquisition funnel | `event=download_clicked`, breakdown `platform`, `location`                    |
