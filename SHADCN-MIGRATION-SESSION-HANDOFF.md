...
fireEvent.change(screen.getByRole('combobox'), { target: { value: 'plywood' } });
...
.platform-darwin { padding-left: 80px; }   /* macOS traffic lights */
.platform-win32 { padding-right: 140px; }  /* Windows controls */
```
...
*Total beads: 11 epics, ~56 sub-beads*
*Estimated total effort: ~4500 minutes (~75 hours)*
