...
4. **Commit messages**: Use conventional commit prefixes: `feat:`, `fix:`, `chore:`, `docs:`, `test:`, `refactor:`.
5. **Branch naming**: Use prefixes: `feat/`, `fix/`, `chore/`, `docs/`, `test/`, `refactor/`.
6. **No direct pushes**: Both `develop` and `main` are protected. All changes go through PRs.
7. **Squash merges to main**: PRs to `main` use squash merge. PRs to `develop` can use regular merge.
