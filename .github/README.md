...
**Jobs:**
- **unit-tests:** Vitest unit and integration tests (Ubuntu, macOS, Windows)
- **e2e-tests:** Playwright E2E tests with Electron (Ubuntu, macOS)
- **lint:** ESLint, TypeScript, and Prettier checks (Ubuntu)
